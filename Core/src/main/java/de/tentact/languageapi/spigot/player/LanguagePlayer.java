...
public class LanguagePlayer implements ILanguagePlayer {
    ...
    @Override
    public void sendSignChange(@NotNull Location loc, @Nullable @Nullable String[] lines) throws IllegalArgumentException {

    }

    @Override
    public void sendSignChange(@NotNull Location loc, @Nullable @Nullable String[] lines, @NotNull DyeColor dyeColor) throws IllegalArgumentException {
    ...
    @Override
    public void setPlayerListHeaderFooter(@Nullable @Nullable BaseComponent[] header, @Nullable @Nullable BaseComponent[] footer) {
    ...
    @Override
    public void showTitle(@Nullable @Nullable BaseComponent[] title) {
    ...
    @Override
    public void showTitle(@Nullable @Nullable BaseComponent[] title, @Nullable @Nullable BaseComponent[] subtitle, int fadeInTicks, int stayTicks, int fadeOutTicks) {
    ...
    @Override
    public void sendMessageByKey(String transkey) {
