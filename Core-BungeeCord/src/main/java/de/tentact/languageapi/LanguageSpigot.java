...
public class LanguageSpigot extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Objects.requireNonNull(this.getCommand("de/tentact/languageapi")).setExecutor(new LanguageCommand(this));
        Objects.requireNonNull(this.getCommand("de/tentact/languageapi")).setTabCompleter(new LanguageCommand(this));
